<?php
  ...
  { 
		...
		public function body()
		{
			...
			public function ui_pricing_box($title, $price, $list, $link, $state=false, $label='Purchase', $style='shadow')
			{
			...
			public function ui_slider($dir, $list, $type='normal')
			{
				$html = '
				<div class="ui-slider '.$type.' cf">
					...
					// Add CTRU if the type is 'background'
					if($type == 'background')
						$html .= '<div class="ctru"></div>';
